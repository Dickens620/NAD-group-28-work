                        ...
                        <div class="relative text-sm">
                            ...
                            <div id="userMenu" class="bg-white nunito rounded shadow-md mt-2 absolute mt-12 top-0 right-0 min-w-full overflow-auto z-30 invisible">
                                <ul class="list-reset">
                                    ...
                                    <li><a href="login.jsp" class="px-4 py-2 block text-gray-900 hover:bg-indigo-400 hover:text-white no-underline hover:no-underline">Logout</a></li>
                                </ul>
                            </div>
                        </div>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Enter patient registration credentials</p>
                  </div>

                  <form class="row g-3 needs-validation" novalidate action="PatientRegj" method="POST">
                    ...
                    <div class="col-12">
                      <label for=health_centre class="form-label">Health Centre</label>
                      <div class="input-group has-validation">
                    ...
                    <div class="col-12">
                      <label for="date_of_administration" class="form-label">Date</label>
                      <input type="date" name="date_of_administration" class="form-control" id="date_of_administration" required>
                     ...
                     <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                         <input type="text" name="batch_number" class="form-control" id="batch_number" required>
                    </div>
                    </div>
                      ...
                      <div class="input-group has-validation">
                         <input type="text" name="vaccine_administered" class="form-control" id="vaccine_administered" required>
                    </div>
                    </div>
