            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Patient Email Form</h5>
                    <p class="text-center small">Enter patient Message and Subject</p>
                  </div>

                  <form class="row g-3 needs-validation" novalidate action="EmailPro" method="POST">

                    <div class="col-12">
                      <label for=nin class="form-label">Email Address</label>
                      <div class="input-group has-validation">
                         <input type="emailt" name="recipient" class="form-control" id="recipient" required>
                    </div>
                    </div>
                       ...
                       <div class="col-12">
                      <label for="date_of_administration" class="form-label">Subject</label>
                    ...
                    <div class="col-13">
                      <label for=health_centre class="form-label">Content</label>
                      <div class="input-group has-validation">
                         
                         <textarea rows="10" cols="39" name="content" id="content" class="form-control"></textarea>
                    </div>
                    </div>
                      
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name="sub">Send Mail</button>
