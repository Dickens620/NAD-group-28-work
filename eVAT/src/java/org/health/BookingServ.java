...
public class BookingServ extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
             ...
             request.setAttribute("date_of_appointment", date_of_appointment);
             request.setAttribute("nin", nin);
             request.setAttribute("time_of_appointment", time_of_appointment);
             request.setAttribute("vaccine", vaccine);
             request.setAttribute("health_centre", health_centre);
             
             request.getRequestDispatcher("BookingTag.jsp").forward(request, response);
